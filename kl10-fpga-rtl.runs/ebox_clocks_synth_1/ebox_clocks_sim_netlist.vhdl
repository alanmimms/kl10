...
--               /home/alan/kl10-fpga-rtl/kl10-fpga-rtl.runs/ebox_clocks_synth_1/ebox_clocks_sim_netlist.vhdl
-- Design      : ebox_clocks
...
entity ebox_clocks_ebox_clocks_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of ebox_clocks_ebox_clocks_clk_wiz : entity is "ebox_clocks_clk_wiz";
end ebox_clocks_ebox_clocks_clk_wiz;

architecture STRUCTURE of ebox_clocks_ebox_clocks_clk_wiz is
  signal clk_in1_ebox_clocks : STD_LOGIC;
  signal clkfbout_buf_ebox_clocks : STD_LOGIC;
  signal clkfbout_ebox_clocks : STD_LOGIC;
  signal eboxClk_ebox_clocks : STD_LOGIC;
  signal eboxClk_ebox_clocks_en_clk : STD_LOGIC;
  signal fastMemClk_ebox_clocks : STD_LOGIC;
  signal fastMemClk_ebox_clocks_en_clk : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_ebox_clocks,
      O => clkfbout_buf_ebox_clocks
    );
...
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      STARTUP_WAIT => false
        ...
        port map (
      CLKFBIN => clkfbout_buf_ebox_clocks,
      CLKFBOUT => clkfbout_ebox_clocks,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_ebox_clocks,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => eboxClk_ebox_clocks,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => fastMemClk_ebox_clocks,
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => fastMemClk_ebox_clocks_en_clk,
      CE => '1',
      D => locked_int,
      Q => seq_reg2(0),
      R => '0'
...
entity ebox_clocks is
  ...
  attribute NotValidForBitStream of ebox_clocks : entity is true;
end ebox_clocks;

architecture STRUCTURE of ebox_clocks is
begin
inst: entity work.ebox_clocks_ebox_clocks_clk_wiz
     port map (
      clk_in1 => clk_in1,
      eboxClk => eboxClk,
