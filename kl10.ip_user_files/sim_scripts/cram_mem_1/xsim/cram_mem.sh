...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cram_mem xil_defaultlib.cram_mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cram_mem -key {Behavioral:kl10pv:Functional:cram_mem} -tclbatch cmd.tcl -log simulate.log
}
