...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fm_mem xil_defaultlib.fm_mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fm_mem -key {Behavioral:test-packed:Functional:fm_mem} -tclbatch cmd.tcl -log simulate.log
}
