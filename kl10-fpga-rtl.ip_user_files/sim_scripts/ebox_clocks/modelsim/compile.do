...
vlog -work xpm -64 -incr -sv -L axi_vip_v1_1_6 -L processing_system7_vip_v1_0_8 -L xilinx_vip "+incdir+../../../ipstatic" "+incdir+/x/Xilinx/Vivado/2019.2/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 -incr "+incdir+../../../ipstatic" "+incdir+/x/Xilinx/Vivado/2019.2/data/xilinx_vip/include" \
