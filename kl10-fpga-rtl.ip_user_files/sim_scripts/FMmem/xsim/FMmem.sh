...
#
# Generated by Vivado on Mon Jan 13 16:17:45 PST 2020
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot FMmem xil_defaultlib.FMmem xil_defaultlib.glbl -log elaborate.log
}
