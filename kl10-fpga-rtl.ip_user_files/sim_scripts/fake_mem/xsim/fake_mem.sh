...
#
# Generated by Vivado on Mon Jan 27 09:28:16 PST 2020
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fake_mem xil_defaultlib.fake_mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fake_mem -key {Behavioral:edp:Functional:fake_mem} -tclbatch cmd.tcl -log simulate.log
}
